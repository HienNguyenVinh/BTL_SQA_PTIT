...
CREATE TABLE CHITIETHOADON(
    ...
    SOLUONG NUMBER,  -- Sử dụng NUMBER thay vì INT
...
CREATE TABLE CHITIETPHIEUNHAP(
    ...
    MASANPHAM VARCHAR2(20),
    DONGIANHAP NUMBER,  -- Sử dụng NUMBER thay vì DOUBLE PRECISION
    SOLUONG NUMBER,  -- Sử dụng NUMBER thay vì INT
...
BEGIN
    IF(:NEW.NGAYSINH > :NEW.NGAYVAOLAM) THEN
        RAISE_APPLICATION_ERROR(-20001, 'Ngày sinh không được sau ngày vào làm!');
END IF;
END;
/
-------------------------------------------------------------
