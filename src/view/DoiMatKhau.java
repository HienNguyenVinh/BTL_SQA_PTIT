...
public class DoiMatKhau extends javax.swing.JFrame {
    ...
    private void XacNhanBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_XacNhanBtnActionPerformed
        char[] matKhauCuChars = MatKhauCuField.getPassword();
        String matKhauCu = new String(matKhauCuChars);
        char[] matKhauMoiChars = MatKhauMoiField.getPassword();
        String matKhauMoi = new String(matKhauMoiChars);
        char[] xacNhanMatKhauChars = XacNhanMatKhauField.getPassword();
        String xacNhanMatKhau = new String(xacNhanMatKhauChars);
        ...
        try {
            ...
            if (tt != 1) {
                JOptionPane.showMessageDialog(rootPane, "Mật khẩu cũ không đúng!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            } else if (!matKhauMoi.equals(xacNhanMatKhau)) {
                JOptionPane.showMessageDialog(rootPane, "Mật khẩu mới không khớp!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            } else {
